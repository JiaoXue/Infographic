...
_e(function (E, $) {
    ...
    Modal.fn.initDom = function () {
        ...
        var $close = $('<div class="wangEditor-modal-close"><i class="fa fa-cancel-circle"></i></div>');
...
_e(function (E, $) {
     ...
     E.UI.menus = {
        ...
        'default': {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-command"></i></a>',
            selected: '.selected'
        },
        bold: {
        ...
        bgcolor: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-brush"></i></a>',
            selected: '.selected'
        },
        strikethrough: {
        ...
        quote: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-quotes-left"></i></a>',
            selected: '.selected'
        },
        source: {
        ...
        fontfamily: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-font2"></i></a>',
            selected: '.selected'
        },
        fontsize: {
        ...
        orderlist: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-list-numbered"></i></a>',
            selected: '.selected'
        },
        unorderlist: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-list-bullet"></i></a>',
            selected: '.selected'
        },
        alignleft: {
        ...
        emotion: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-happy"></i></a>',
            selected: '.selected'
        },
        img: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-picture"></i></a>',
            selected: '.selected'
        },
        video: {
        ...
        location: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-location"></i></a>',
            selected: '.selected'
        },
        insertcode: {
        ...
        undo: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-ccw"></i></a>',
            selected: '.selected'
        },
        redo: {
            normal: '<a href="#" tabindex="-1"><i class="fa fa-cw"></i></a>',
            selected: '.selected'
        },
        fullscreen: {
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        // 自定义UI，并添加到上传dom节点上
        var $uploadIcon = $('<div class="upload-icon-container"><i class="fa fa-upload"></i></div>');
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var $zoomSmall = $('<a href="#"><i class="fa fa-search-minus"></i></a>');
        var $zoomBig = $('<a href="#"><i class="fa fa-search-plus"></i></a>');
        // var $floatLeft = $('<a href="#"><i class="fa fa-align-left"></i></a>');
        // var $noFloat = $('<a href="#"><i class="fa fa-align-justify"></i></a>');
        // var $floatRight = $('<a href="#"><i class="fa fa-align-right"></i></a>');
...
_e(function (E, $) {
    E.plugin(function () {
        ...
        var $toolbar = $('<div class="txt-toolbar"></div>');
        var $triangle = $('<div class="tip-triangle"></div>');
        var $triggerLink = $('<a href="#" target="_blank"><i class="fa fa-link"></i> ' + lang.openLink + '</a>');
        var isRendered;
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var menu = new E.Menu({
            ...
            $domNormal: $('<a href="#" tabindex="-1"><i class="fa fa-indent-left"></i></a>'),
            $domSelected: $('<a href="#" tabindex="-1" class="selected"><i class="fa fa-indent-left"></i></a>')
        });
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var menu = new E.Menu({
            ...
            // 正常状态和选中装下的dom对象，样式需要自定义
            $domNormal: $('<a href="#" tabindex="-1"><i class="fa fa-arrows-v"></i></a>'),
            $domSelected: $('<a href="#" tabindex="-1" class="selected"><i class="fa fa-arrows-v"></i></a>')
        });
